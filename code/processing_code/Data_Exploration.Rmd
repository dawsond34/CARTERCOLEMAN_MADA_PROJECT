...
```{r}
MIDO <- readRDS("../../data/processed_data/MIDO.rds")
NORO <- readRDS("../../data/processed_data/NORO.rds")
BICO <- readRDS("../../data/processed_data/BICO.rds")
```
 <- source("processingscript.R", local = knitr::knit_global())
